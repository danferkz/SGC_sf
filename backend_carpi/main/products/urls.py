...
from .views import CalcularPrecioPuertaView, CalcularPrecioVentanaView, CalcularPrecioMuebleView, ProductDoorCreateView, ProductWindowCreateView, ProductFurnitureCreateView, ProductDoorCreateView, ProductWindowCreateView, ProductFurnitureCreateView,   ProductDoorCreateView, ProductWindowCreateView, ProductFurnitureCreateView
