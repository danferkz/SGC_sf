...
class DoorWindowAdmin(admin.ModelAdmin):
    list_display = ('id', 'product_type', 'wood_type', 'cost_price', 'is_varnished', 'length', 'width', 'is_exterior', 'number_of_sheets', 'created_at', 'updated_at')
    list_filter = ('product_type', 'wood_type', 'is_varnished', 'is_exterior')
    search_fields = ('id', 'wood_type', 'length', 'width')
    ordering = ('created_at',)
    date_hierarchy = 'created_at'

class FurnitureAdmin(admin.ModelAdmin):
    list_display = ('id', 'piece_name', 'wood_type', 'cost_price', 'is_varnished', 'weight', 'is_part_of_set', 'set_name', 'created_at', 'updated_at')
    list_filter = ('is_part_of_set', 'wood_type', 'is_varnished')
    search_fields = ('id', 'piece_name', 'set_name', 'wood_type')
    ordering = ('created_at',)
    date_hierarchy = 'created_at'
