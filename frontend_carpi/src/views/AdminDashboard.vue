...
const administradores = ref([
  { id: 1, nombre: 'Admin Uno', email: 'admin1@example.com', rol: 'admin', ultimoAcceso: '2023-05-15T10:30:00' },
  { id: 2, nombre: 'Super Admin', email: 'superadmin@example.com', rol: 'superadmin', ultimoAcceso: '2023-05-14T15:45:00' },
  { id: 3, nombre: 'Admin Dos', email: 'admin2@example.com', rol: 'admin', ultimoAcceso: '2023-05-13T09:00:00' },
  // ... más administradores
])
...
const administradoresFiltrados = computed(() => {
  return administradores.value
    .filter(admin => 
      ...
      admin.rol.toLowerCase().includes(busqueda.value.toLowerCase())
    )
})
