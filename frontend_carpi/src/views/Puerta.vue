          ...
          <div>
            ...
            <div class="mt-2 flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-10">
              <div class="flex items-center">
                <input id="simple" type="radio" v-model="formData.doorStyle" value="simple" class="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300">
                <label for="simple" class="ml-3 block text-sm font-medium text-gray-700">Simple</label>
              </div>
              <div class="flex items-center">
                <input id="paneled" type="radio" v-model="formData.doorStyle" value="paneled" class="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300">
                <label for="paneled" class="ml-3 block text-sm font-medium text-gray-700">Con Paneles</label>
              </div>
              <div class="flex items-center">
                <input id="glasspane" type="radio" v-model="formData.doorStyle" value="glasspane" class="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300">
            ...
            <div class="mt-2 space-y-2">
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input id="doorknob" type="checkbox" v-model="formData.hardware.doorknob" class="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300 rounded">
                </div>
              ...
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input id="lock" type="checkbox" v-model="formData.hardware.lock" class="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300 rounded">
                </div>
                <div class="ml-3 text-sm">
              ...
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input id="hinges" type="checkbox" v-model="formData.hardware.hinges" class="focus:ring-amber-500 h-4 w-4 text-amber-600 border-gray-300 rounded">
                </div>
                <div class="ml-3 text-sm">
